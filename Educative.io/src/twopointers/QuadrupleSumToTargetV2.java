...
public class QuadrupleSumToTargetV2 {
    ...
    public static void main(String[] args) {
        System.out.println(QuadrupleSumToTargetV2.searchQuadruplets(new int[] { 4, 1, 2, -1, 1, -3 }, 1));
        System.out.println(QuadrupleSumToTargetV2.searchQuadruplets(new int[] { 2, 0, -1, 1, -2, 2 }, 2));
    }
}
